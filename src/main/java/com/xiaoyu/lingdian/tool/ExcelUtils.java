...
public class ExcelUtils {
     ...
     * 导入xls文件1
     */
    public static List<String[]> importXls1(InputStream inputStream) {
     ...
     * 导入xls文件2
     */
    public static List<String[]> importXls2(InputStream inputStream) {
    	List<String[]> dataList = new ArrayList<String[]>();        
    	HSSFWorkbook rwb;
		try {
     ...
     * @throws IOException
     */
    public static List<String[]> importExcel(InputStream inp) throws IOException {
        if (!inp.markSupported()) {
            inp = new PushbackInputStream(inp, 8);
        }
        if (POIFSFileSystem.hasPOIFSHeader(inp)) {
            return importXls2(inp);
        }
        if (POIXMLDocument.hasOOXMLHeader(inp)) {
            return importXlsx(inp);
        }
        throw new IllegalArgumentException("excel版本不支持");
    }
